...
Scenario: Add new Openstack connection under Cloud Hub
	...
	When I start new configuration and set fields as "test","localhost","RESTAPIACCESS","OAv8xVUnH8WeO2h0qzU2CIdH+1CJbrJxssv95GF4skE=","agno.groundwork.groundworkopensource.com","6fd89a41705441a5b718aebe07a763d0","demo","demo","55d794a346cf413a","8774","5000","8777","5","-1"
...
Scenario: Verify Openstack test connection with invalid input
 	Given I am on the Cloud Hub page
 	When I select "Openstack" for new connection
 	When I start new configuration and set fields as "test123","localhost123","RESTAPIACCESS123","testing=","agno.groundwork.groundworkopensource.com","6fd89a41705441a5b718aebe07a763d011","demo11","demo11","55d794a346cf413a11","8774","5000","8777","5","-1"
 	And I save the connection
 	And test connection is done
...
Scenario: Verify Openstack connection with special characters and long strings
 	Given I am on the Cloud Hub page
 	When I select "Openstack" for new connection
 	When I start new configuration and set fields as "@R$%^T","test987","#%#$$$","!@#$%^&*()_+abvfcdeswaqzxsedcf","!@#$%^&*()_+abvfcdeswaqzxsedcf","!@#$%^&*()_+abvfcdeswaqzxsedcf","*%&*%*&%(*%","7","2345343","8774","5000","8777","5","-1"
 	And I save the connection
 	And test connection is done
 	Then verify connection is not established  
 	And I navigate to cloud hub home page
...
Scenario: Verify error messages on entering special characters in Warning and Critical thresholds fields 
 	Given I am on the Cloud Hub page
	When I select "Openstack" for new connection
 	When I start new configuration and set fields as "test1234","localhost","RESTAPIACCESS","OAv8xVUnH8WeO2h0qzU2CIdH+1CJbrJxssv95GF4skE=","agno.groundwork.groundworkopensource.com","6fd89a41705441a5b718aebe07a763d0","demo","demo","55d794a346cf413a","8774","5000","8777","5","-1"
 	And I save the connection
 	And test connection is done
...
Scenario: Verify Openstack connection with special characters in check interval field
 	Given I am on the Cloud Hub page
 	When I select "Openstack" for new connection
 	When I start new configuration and set fields as "test1234","localhost","RESTAPIACCESS","OAv8xVUnH8WeO2h0qzU2CIdH+1CJbrJxssv95GF4skE=","agno.groundwork.groundworkopensource.com","6fd89a41705441a5b718aebe07a763d0","demo","demo","55d794a346cf413a","8774","5000","8777","ngsji","-1"
 	And I save the connection
...
Scenario: Verify Openstack test connection with invalid ports
 	Given I am on the Cloud Hub page
 	When I select "Openstack" for new connection
 	When I start new configuration and set fields as "test345","localhost","RESTAPIACCESS","OAv8xVUnH8WeO2h0qzU2CIdH+1CJbrJxssv95GF4skE=","agno.groundwork.groundworkopensource.com","6fd89a41705441a5b718aebe07a763d0","demo","demo","55d794a346cf413a","4005","4005","8877","5","-1"
 	And I save the connection
	And test connection is done
...
Scenario: Verify editing Hypervisor Services on Thresholds configuration page
 	...
 	And test connection is done
 	And I click next button
	And I select "Hypervisor" service "free_disk_gb" and set thresholds as "9999999999" and "9999999999"
...
Scenario: Verify editing Virtual Machine Services on Thresholds configuration page
 	...
 	And test connection is done
 	And I click next button
	And I select "Virtual Machine" service "cpu_util" and set thresholds as "9999999999" and "9999999999"
 	And I remove a "Virtual Machine" service "disk.read.bytes"
 	And save it
